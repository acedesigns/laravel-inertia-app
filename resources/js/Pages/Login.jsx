...
export default function Login() {
    ...
    return (
        <>
            <div className="min-h-screen flex justify-center bg-gray-100 rounded-lg dark:bg-gray-800 py-12 px-4 sm:px-6 lg:px-8 transition-colors">
                        ...
                        <div className="rounded-md shadow-sm space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    } placeholder-gray-500 dark:placeholder-gray-400 text-gray-900 dark:text-white bg-white dark:bg-gray-800 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:focus:ring-indigo-400 dark:focus:border-indigo-400 sm:text-sm transition-colors`}
                        ...
                        <div>
                            ...
                            >
                                <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                                    <svg className="h-5 w-5 text-indigo-500 group-hover:text-indigo-400 dark:text-indigo-300" fill="currentColor" viewBox="0 0 20 20">
